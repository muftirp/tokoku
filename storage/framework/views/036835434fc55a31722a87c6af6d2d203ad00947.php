      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td>10000</td>
            <td>3</td>
            <td><a  href="<?php echo e(url('edit')); ?>" class="btn btn-secondary" >Edit</a>  <a href="#" class="btn btn-danger">Delete</a></td>
          </tr>
          <tr>
            <th scope="row">2</th>
            <td>sepatu</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel project\tokoku1\resources\views/dashboard.blade.php ENDPATH**/ ?>
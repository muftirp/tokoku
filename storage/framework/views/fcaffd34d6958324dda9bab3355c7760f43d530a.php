...
<a class="btn btn-primary mb-3" href="<?php echo e(url('admin')); ?>">Back to home</a>
<form method="post" action="<?php echo e(url('product')); ?>" class="form-horizontal">
<fieldset>
<!-- Form Name -->
...
<?php /**PATH D:\laravel project\tokoku1\resources\views/admin/product/add.blade.php ENDPATH**/ ?>
...
<a class="btn btn-primary mb-3" href="<?php echo e(url('dashboard')); ?>">Back to home</a>
<form method="post" action="<?php echo e(url('category')); ?>" class="form-horizontal">
<?php echo csrf_field(); ?>
  <fieldset>
<!-- Form Name -->
...
<?php /**PATH D:\laravel project\tokoku1\resources\views/admin/category/add.blade.php ENDPATH**/ ?>